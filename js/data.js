...
async function renderGlobalNav() {
  ...
  // Ensure theme toggle exists in right zone
  if (rightZone && !document.getElementById("nav-theme-toggle")) {
    const themeBtn = document.createElement("button");
    themeBtn.className = "sh-theme-toggle nav-theme-btn";
    ...
    if (toggle) {
      rightZone.insertBefore(themeBtn, toggle);
    } else {
      rightZone.appendChild(themeBtn);
    }
